...
## Intégration HubSpot CRM Avancée - Phase 4

- [x] Configurer les procédures tRPC pour HubSpot (contacts, deals, tasks)
- [x] Créer le tableau de bord admin HubSpot dans le site
- [x] Implémenter la gestion des contacts depuis l'admin
- [x] Implémenter la gestion des opportunités depuis l'admin
- [x] Ajouter les statistiques et rapports HubSpot
...
## Optimisation Performance, Bugs et SEO - Phase Finale

### Performance et Optimisation
- [ ] Corriger les erreurs TypeScript (erreurs de compilation)
...
- [ ] Minifier et compresser le CSS/JS
- [ ] Implémenter la mise en cache (cache headers)
- [ ] Optimiser les fonts Google (preload, display: swap)

### SEO et Référencement
- [ ] Ajouter les meta tags pour les mots-clés ciblés
- [ ] Optimiser les titres et descriptions pour chaque page
- [ ] Ajouter le structured data (JSON-LD) pour les services
- [ ] Créer/mettre à jour le sitemap.xml
- [ ] Ajouter les balises Open Graph pour les réseaux sociaux
- [ ] Configurer le fichier robots.txt
- [ ] Ajouter les breadcrumbs structurés
- [ ] Optimiser les URLs pour le SEO

### Nouvelles Pages de Services
- [ ] Créer la page "Nettoyage de Bureaux"
- [ ] Créer la page "Nettoyage de Commerce"
- [ ] Créer la page "Nettoyage de Panneaux Solaires"
- [ ] Ajouter les mots-clés locaux (Pontoise, Île-de-France, etc.)
- [ ] Intégrer les liens internes entre services

### Configuration du Domaine
- [ ] Configurer procleanempire.com dans les settings Manus
- [ ] Ajouter les DNS records si nécessaire
- [ ] Vérifier le SSL/HTTPS
- [ ] Configurer les redirects HTTP vers HTTPS

### Tests et Validation
- [ ] Tester la performance avec Google PageSpeed Insights
- [ ] Vérifier les erreurs TypeScript
- [ ] Tester le site sur mobile/tablet/desktop
...
- [ ] Fournir un rapport de performance
