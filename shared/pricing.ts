...
export const SERVICES: Record<string, Service> = {
  automobile: {
    ...
    options: [
      {
        id: "auto-exterieur",
        label: "30€ - Nettoyage extérieur uniquement",
        price: 30,
        description: "Lavage extérieur complet, séchage professionnel, finition brillante",
      },
      {
        id: "auto-interieur",
        label: "60€ - Nettoyage intérieur uniquement",
        price: 60,
        description: "Nettoyage intérieur complet, aspirateur professionnel, désodorisation",
      },
      {
        id: "auto-sans-sieges",
        label: "90€ - Nettoyage intérieur + extérieur (sans siège)",
        price: 90,
        description: "Lavage extérieur complet, nettoyage intérieur, séchage professionnel",
      },
      {
        id: "auto-complet",
        label: "110€ - Nettoyage complet",
        price: 110,
        description: "Lavage complet, lustrage professionnel, protection brillance",
      },
      {
        id: "auto-suv",
        label: "150€ - SUV nettoyage intérieur + extérieur",
        price: 150,
        description: "Lavage haute pression, nettoyage intérieur complet, finition premium",
      },
      {
        id: "auto-suv-complet",
