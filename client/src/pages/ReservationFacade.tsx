...
const SERVICES = {
  facade_jusqua_50: {
    name: "Façade jusqu'à 50m²",
    price: 200,
    description: "Nettoyage de façade pour une surface jusqu'à 50m²",
    includedServices: ["facade_jusqua_50"]
  },
  facade_50_100: {
    name: "Façade 50-100m²",
    price: 350,
    description: "Nettoyage de façade pour une surface entre 50 et 100m²",
    includedServices: ["facade_50_100"]
  },
  facade_plus_100: {
    name: "Façade > 100m²",
    price: 500,
    description: "Nettoyage de façade pour une surface supérieure à 100m²",
    includedServices: ["facade_plus_100"]
  }
};

const ALL_OPTIONS = [
  { id: "traitement_hydrofuge", name: "Traitement hydrofuge", price: 80, excludedFrom: [] },
  { id: "nettoyage_gouttieres", name: "Nettoyage gouttières", price: 50, excludedFrom: [] },
  { id: "traitement_anti_mousse", name: "Traitement anti-mousse", price: 40, excludedFrom: [] },
  { id: "ravalement_leger", name: "Ravalement léger", price: 100, excludedFrom: [] },
];

export default function ReservationFacade() {
