    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-96 overflow-hidden bg-gradient-to-r from-blue-600 to-blue-700 flex items-center justify-center">
        <div className="text-center text-white px-4">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">Nettoyage Balcon</h1>
          <p className="text-lg md:text-xl">Nettoyez votre balcon en profondeur avec nos services professionnels</p>
        </div>
      </section>
