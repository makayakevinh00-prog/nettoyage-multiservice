...
const SERVICES = {
  balcon_standard: {
    name: "Balcon standard",
    price: 50,
    description: "Nettoyage de balcon standard",
    includedServices: ["balcon"]
  },
  balcon_garde_corps: {
    name: "Balcon avec garde-corps",
    price: 70,
    description: "Nettoyage de balcon avec garde-corps",
    includedServices: ["balcon", "garde_corps"]
  },
  grand_balcon: {
    name: "Grand balcon/loggia",
    price: 100,
    description: "Nettoyage de grand balcon ou loggia",
    includedServices: ["balcon_grand"]
  }
};

const ALL_OPTIONS = [
  { id: "nettoyage_joints", name: "Nettoyage joints", price: 20, excludedFrom: [] },
  { id: "nettoyage_garde_corps", name: "Nettoyage garde-corps", price: 15, excludedFrom: ["balcon_garde_corps"] },
  { id: "impermeabilisation", name: "Imperméabilisation", price: 30, excludedFrom: [] },
  { id: "nettoyage_mobilier", name: "Nettoyage mobilier", price: 15, excludedFrom: [] },
];

export default function ReservationBalcon() {
