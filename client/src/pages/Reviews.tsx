  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
      ...
      <main className="flex-1">
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-700">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mt-8">
                <a
                  href="https://fr.trustpilot.com/review/procleanempire.com#write-review"
                  target="_blank"
