  ...
  const services = [
    {
      ...
      image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663223121429/bpJnZERihBdDiDPT.jpg",
    ...
    },
    {
      ...
      image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663223121429/wBEaFTQafyTkjwjR.jpg",
    ...
    },
    {
      ...
      image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663223121429/AaMDBzTnzROeAARM.jpg",
      link: "/service/tapis",
    },
    {
      icon: Building2,
      ...
      image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663223121429/DmDEwSOsTNqZHhoi.jpg",
      link: "/service/balcon",
    },
    {
      icon: Leaf,
      ...
      image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663223121429/xzNVsBcFbhxDIrZv.jpg",
    ...
    },
    {
      ...
      image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663223121429/qqwrFwTexatFKHux.jpg",
      link: "/service/facade",
    },
    {
      icon: Droplets,
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, i) => {
                ...
                return (
                  ...
                  >
                    <div className="relative h-48 overflow-hidden bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
                      <div className="text-center">
                        <Icon className="w-16 h-16 text-white mb-2 mx-auto" />
