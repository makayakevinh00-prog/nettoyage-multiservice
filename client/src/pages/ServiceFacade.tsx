...
export default function ServiceFacade() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Nettoyage profond des joints et des fissures",
    },
    {
      name: "Traitement Protecteur",
      description: "Application de protection anti-mousse durable",
    },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-96 overflow-hidden bg-gradient-to-r from-blue-600 to-blue-700 flex items-center justify-center">
        <div className="text-center text-white px-4">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">Nettoyage Façade</h1>
          <p className="text-lg md:text-xl">Redonnez éclat à votre façade avec notre service de nettoyage professionnel</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Nos équipes utilisent les technologies les plus avancées pour nettoyer votre façade en profondeur. 
      ...
      <section className="py-16">
        <div className="container max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Prêt à nettoyer votre façade ?</h2>
