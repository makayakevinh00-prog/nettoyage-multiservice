...
const SERVICES = {
  petit_jardin: {
    name: "Entretien petit jardin (< 50m²)",
    price: 60,
    description: "Entretien complet pour les petits jardins",
    includedServices: ["jardinage"]
  },
  moyen_jardin: {
    name: "Entretien moyen jardin (50-150m²)",
    price: 100,
    description: "Entretien complet pour les jardins moyens",
    includedServices: ["jardinage"]
  },
  grand_jardin: {
    name: "Entretien grand jardin (> 150m²)",
    price: 150,
    description: "Entretien complet pour les grands jardins",
    includedServices: ["jardinage"]
  }
};

const ALL_OPTIONS = [
  { id: "taille_haies", name: "Taille de haies", price: 30, excludedFrom: [] },
  { id: "tonte_pelouse", name: "Tonte pelouse", price: 25, excludedFrom: [] },
  { id: "desherbage", name: "Désherbage", price: 20, excludedFrom: [] },
  { id: "ramassage_feuilles", name: "Ramassage feuilles", price: 15, excludedFrom: [] },
  { id: "elagage_arbustes", name: "Élagage arbustes", price: 40, excludedFrom: [] },
];

export default function ReservationJardinage() {
