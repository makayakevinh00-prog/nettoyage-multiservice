...
const SERVICES = {
  tapis_petit: {
    name: "Tapis petit format (< 3m²)",
    price: 40,
    description: "Nettoyage en profondeur pour petits tapis",
    includedServices: ["nettoyage"]
  },
  tapis_moyen: {
    name: "Tapis moyen format (3-6m²)",
    price: 70,
    description: "Nettoyage en profondeur pour tapis moyens",
    includedServices: ["nettoyage"]
  },
  tapis_grand: {
    name: "Tapis grand format (> 6m²)",
    price: 100,
    description: "Nettoyage en profondeur pour grands tapis",
    includedServices: ["nettoyage"]
  },
  canape: {
    name: "Canapé 2-3 places",
    price: 80,
    description: "Nettoyage complet du canapé",
    includedServices: ["nettoyage"]
  }
};

const ALL_OPTIONS = [
  { id: "detachage", name: "Détachage professionnel", price: 20, excludedFrom: [] },
  { id: "anti_acariens", name: "Traitement anti-acariens", price: 15, excludedFrom: [] },
  { id: "protection", name: "Protection anti-taches", price: 25, excludedFrom: [] },
  { id: "desodorisation", name: "Désodorisation", price: 15, excludedFrom: [] },
];

export default function ReservationTapis() {
  ...
  const handleReserve = () => {
    ...
    localStorage.setItem("reservationData", JSON.stringify({
      service: "🛋️ Nettoyage Tapis & Canapés",
                ...
                <>
                  <div className="border-t border-blue-200 pt-4">
                    ...
                    {selectedOptions.map(optionId => {
                      const option = ALL_OPTIONS.find(o => o.id === optionId);
                      return (
                        <div key={optionId} className="flex justify-between text-gray-700 ml-4 mb-2">
